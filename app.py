...
if view_mode == "Wgraj Zdjecie (Goscie)":
        ...
        if uploaded_files:
            ...
            if st.button("Wyslij zdjecia do pokazu"):
                ...
                for i, uploaded_file in enumerate(uploaded_files):
                    ...
                    status_text.text(f"AnalizujÄ™ zdjÄ™cie {i+1} z {total_files}...")
                    ...
                    try:
                        ...
                        for attempt in range(3):
                            ...
                            try:
                                ...
                                prompt = (
                                    ...
                                    "JesteÅ› bezczelnym komikiem na 18. urodzinach. SpÃ³jrz na to konkretne zdjÄ™cie i OPISZ DOKÅ ADNIE CO NA NIM WIDZISZ: "

                                    "kto tam jest, w co sÄ… ubrani, jakie majÄ… miny, co trzymajÄ… w rÄ™kach lub co robiÄ…. "

                                    "Na tej podstawie skomentuj to zÅ‚oÅ›liwie lub Å¼artobliwie w 1-2 krÃ³tkich zdaniach z emoji. "

                                    "BEZWZGLÄ˜DNY ZAKAZ stosowania ogÃ³lnikowych haseÅ‚ o 'imprezie' â€“ tekst musi opisywaÄ‡ ten konkretny kadr! "

                                    "ZwrÃ³Ä‡ absolutnie tylko sam tekst podpisu, bez Å¼adnych cudzysÅ‚owÃ³w."
                        ...
                        if not success_ai:
                            ...
                            caption = f"UjÄ™cie #{i+1} z osiemnastki Zuzi! ðŸ“¸ðŸ”¥"
                        ...
                        st.error(f"BÅ‚Ä…d przy zdjÄ™ciu {i+1}: {e}")
                ...
                status_text.text("Gotowe! ZdjÄ™cia trafiÅ‚y na ekran.")
    ...
    if items:
        ...
        st.info("Czekamy na pierwsze zdjecia! Wrzuc coÅ› ze swojego telefonu.")
